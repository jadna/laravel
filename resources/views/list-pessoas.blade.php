        ...
        <div id="line-one">   
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">   
                        <br />
                        <h4 id="center"><b>Clientes Cadastrados </b></h4>
                        <br>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="center">Estado Nascimento</th>   
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td title="Nome">{{$pessoa->nome}}</td>
                                        <td title="CPF">{{$pessoa->cpf}}</td>
                                        <td title="RG" id="center">{{$pessoa->rg}}</td>
                                        <td title="Data Nascimento">{{\Carbon\Carbon::parse($pessoa->data_nasc)->format('d/m/Y')}}</td> 
                                        <td title="Estado Nascimento">{{$pessoa->local_nasc}}</td>
                                        <td title="Telefone">{{$pessoa->telefone}}</td>
